...
return [
    ...
    'list' => [
        ...
        'drugstores' => [
            'list'      => 'drugstores.list',
            'create'    => 'drugstores.create',
            'update'    => 'drugstores.update',
            'delete'    => 'drugstores.delete'
        ],
        'medicines' => [
            'list'      => 'medicines.list',
        ...
        'symptoms' => [
            ...
            'delete'    => 'symptoms.delete'
        ],
        'disease-symptoms' => [
            'list'      => 'disease-symptoms.list',
            'create'    => 'disease-symptoms.create',
            'update'    => 'disease-symptoms.update',
            'delete'    => 'disease-symptoms.delete'
        ],
        'prescriptions' => [
        ...
        'post-tags' => [
            ...
            'update'    => 'post-tags.update',
            'delete'    => 'post-tags.delete'
        ],
    ]
];
